...
pipeline {
	...
	stage('Is this run required?') {
	   steps {
        geturl1 = new URL('https://calendarific.com/api/v2/holidays?&api_key=d20d05ccb411d9ce3b56b654971e17a29b0aa1ed&country=IN&year=2021').openConnection()
        getRC1 = geturl1.getResponseCode();
